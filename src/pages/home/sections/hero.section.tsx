...
const HeroSection = () => {
  return (
    <div className='h-screen relative '>
        <div className='w-full  h-[450px] b flex-col flex mx-auto items-center justify-center '>
          <div className='flex-col relative flex mx-auto items-center justify-center'>
            <h1 className='text-white relative w-[960px] text-center font-[700] font-inter text-[86px]/[99px]'>
              ...
              <p className='text-[18px] w-[395px] pt-5 font-inter text-center text-white'>Borrow, lend, and earn interest</p>
              <Button className='w-[187px] h-[56px] mt-6'>Launch dApp</Button>  
          </div>        
        </div>
